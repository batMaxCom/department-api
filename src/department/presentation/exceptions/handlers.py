...
from department.domain.common.domain_errors import DomainTypeError, DomainError
from department.infrastructure.common.infrastructure_errors import InfrastructureError
from department.presentation.schemas.base import ErrorResponse
...
STATUS_MAP: Final[dict[ApplicationTypeError | DomainTypeError, int]] = {
    ...
    ApplicationTypeError.VALIDATION: HTTP_422_UNPROCESSABLE_CONTENT,
    ApplicationTypeError.CONFLICT: HTTP_409_CONFLICT,
    DomainTypeError.VALIDATION: HTTP_422_UNPROCESSABLE_CONTENT,
    DomainTypeError.FORBIDDEN: HTTP_403_FORBIDDEN,
